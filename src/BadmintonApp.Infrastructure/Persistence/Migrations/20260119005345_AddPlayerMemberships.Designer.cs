...
namespace BadmintonApp.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260119005345_AddPlayerMemberships")]
    partial class AddPlayerMemberships
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BadmintonApp.Domain.Clubs.LocationAmenity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BadmintonApp.Domain.Media.MediaItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("OwnerType", "OwnerId", "Kind");

                    b.HasIndex("OwnerType", "OwnerId", "Kind", "SortOrder", "CreatedAt");
            ...
            modelBuilder.Entity("BadmintonApp.Domain.Players.PlayerClubMembership", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BadmintonApp.Domain.Players.PlayerFavoriteLocation", b =>
                {
                    ...
                    b.ToTable("PlayerFavoriteLocation");
                });

            modelBuilder.Entity("BadmintonApp.Domain.Players.PlayerSportProfile", b =>
                {
                    b.Property<Guid>("PlayerId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("PlayerId", "Sport");

                    b.ToTable("PlayerSportProfiles");
                });

            modelBuilder.Entity("BadmintonApp.Domain.Players.PlayerSubscription", b =>
                {
                    b.Property<Guid>("FollowerPlayerId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("FollowingPlayerId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BadmintonApp.Domain.Core.Role", b =>
                {
                    ...
                    b.HasOne("BadmintonApp.Domain.Core.Staff", null)
                        .WithMany("Roles")
            ...
            modelBuilder.Entity("BadmintonApp.Domain.Players.PlayerSubscription", b =>
                {
                    b.HasOne("BadmintonApp.Domain.Players.Player", "FollowerPlayer")
                        .WithMany("Following")
                        .HasForeignKey("FollowerPlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BadmintonApp.Domain.Players.Player", "FollowingPlayer")
                        .WithMany("Followers")
                        .HasForeignKey("FollowingPlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("FollowerPlayer");

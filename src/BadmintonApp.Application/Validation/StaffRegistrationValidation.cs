...
public class StaffRegistrationValidation : AbstractValidator<StaffRegisterDto>
{
    public StaffRegistrationValidation(IUserRepository userRepository, IClubsRepository clubsRepository)
    {
        RuleFor(x => x.Email)
